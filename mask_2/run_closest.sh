...
~/programs/gofasta/gofasta closest -t2 --number 1000 --target CAMC-CBA018/background.L.fasta --query CAMC-CBA018/CAMC-CBA018.L.fasta > CAMC-CBA018/L.closest.csv
~/programs/gofasta/gofasta closest -t2 --number 1000 --target CAMC-CBA018/background.R.fasta --query CAMC-CBA018/CAMC-CBA018.R.fasta > CAMC-CBA018/R.closest.csv
rm CAMC-CBA018/background*fasta
